...
class MainMenuState extends MusicBeatState
{
	...
	var optionShit:Array<String> = ['story mode', 'freeplay', 'options', 'credits', 'discord', 'ost'];
	...
	override function create()
		{
			...
			camFollow = new FlxObject(0, 1, 2, 3);
			add(camFollow);
			...
			if (!selectedSomethin)
			{
				...
				if (controls.ACCEPT)
				{
					if (optionShit[curSelected] == 'ost')
						{
							...
							FlxG.openURL('https://youtube.com/playlist?list=PLDbcNYoooqPfPP195ajxvhga3cjdR3g0Q');
					...
					if (optionShit[curSelected] == 'discord')
					{
						...
						FlxG.openURL('https://discord.gg/y6RuRHhuSj');
