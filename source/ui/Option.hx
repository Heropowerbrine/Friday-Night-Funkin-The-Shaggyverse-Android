...
class BoolOption extends Option
{
    ...
    override function update(elapsed:Float)
    {
        ...
        if(FlxG.keys.justPressed.ENTER && Alphabet_Text.targetY == 0 && OptionsMenu.androidaccept)
            ChangeValue();
    }
...
class PageOption extends Option
{
    ...
    override function update(elapsed:Float)
    {
        ...
        if(FlxG.keys.justPressed.ENTER && Std.int(Alphabet_Text.targetY) == 0 && !OptionsMenu.inMenu && OptionsMenu.androidaccept)
